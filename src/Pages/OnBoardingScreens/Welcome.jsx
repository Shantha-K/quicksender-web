  ...
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center bg-white">
      ...
      <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center items-center text-center lg:text-left">
        ...
        <img src={delivery_van} alt="Delivery Van" className="w-64 h-auto" />
      </div>

      {/* Right Section */}
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8">
        <img src={shifter} alt="Shifter Logo" className="w-52 h-auto mb-4" />
        <h2 className="text-3xl font-semibold mb-6">Shifter</h2>

        <button className="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded-md w-40 mb-3">
          Log In
        </button>
        <button className="border border-gray-300 hover:bg-gray-100 text-gray-700 px-6 py-2 rounded-md w-40">
          Sign Up
        </button>
      </div>
    </div>
